...
const UserProfile = () => import("~/views/pages/users/UserProfile.vue")
const UserAssessments = () => import("~/views/pages/users/UserAssessments.vue")
const UserReports = () => import("~/views/pages/users/UserReports.vue")
